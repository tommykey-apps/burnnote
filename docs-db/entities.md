...
| Field | Type | Source |
|---|---|---|
| `id` | str (URL-safe base64, 16 bytes = 128 bit エントロピー) | [NoteRepository.php:11](../api/app/Services/NoteRepository.php#L11) (`ID_BYTES = 16`), [NoteRepository.php:100](../api/app/Services/NoteRepository.php#L100) (`generateId`) |
| `ciphertext` | str (AES-256-GCM 暗号文 base64) | [NoteRepository.php:26](../api/app/Services/NoteRepository.php#L26) |
| `iv` | str (初期化ベクトル base64) | [NoteRepository.php:27](../api/app/Services/NoteRepository.php#L27) |
| `created_at` | int (Unix timestamp) | [NoteRepository.php:28](../api/app/Services/NoteRepository.php#L28) |
| `expires_at` | int (Unix timestamp、**DynamoDB TTL: 自動削除トリガー**) | [NoteRepository.php:29](../api/app/Services/NoteRepository.php#L29) |
